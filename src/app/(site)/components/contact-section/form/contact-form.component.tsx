  ...
  return (
    ...
    >
      <div className='font-bold text-2xl tracking-wide '>
        <span className='text-gray opacity-[0.15]'>.</span>getInTouch
      ...
      <div className='space-y-2'>
        ...
        <input
          ...
          type='text'
          className='focus:outline-none w-full p-2 rounded border border-purple bg-smoky-black text-white'
          {...form.register('name')}
        />
      </div>
      <div className='space-y-2'>
      ...
      <div className='space-y-2'>
        ...
        <textarea
          ...
          className='focus:outline-none w-full border border-purple bg-smoky-black text-white p-2 h-40'
